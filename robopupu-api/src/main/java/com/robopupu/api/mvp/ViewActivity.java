...
public abstract class ViewActivity<T_Presenter extends Presenter> extends Activity
    ...
    protected void onStart() {
        ...
        // restored when and if the View resumes. Invoking resolvePresenter method takes care of
        // restoring the reference to Presenter
        final T_Presenter presenter = resolvePresenter();
        if (presenter != null) {
     ...
     * classes extended from {@link ViewActivity}.
     */
    @CallSuper
