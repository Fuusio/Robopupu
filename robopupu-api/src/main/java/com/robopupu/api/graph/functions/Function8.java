 ...
 */
public interface Function8<IN1, IN2, IN3, IN4, IN5, IN6, IN7, IN8, OUT> {
     ...
     */
    OUT eval(IN1 input1, IN2 input2, IN3 input3, IN4 input4, IN5 input5, IN6 input6, IN7 input7, IN8 input8);
}
