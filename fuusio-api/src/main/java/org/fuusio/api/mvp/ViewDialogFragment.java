...
public abstract class ViewDialogFragment<T_Presenter extends Presenter> extends DialogFragment
    ...
    /**
     * This method can be overridden to save state of this {@link ViewDialogFragment} to the given
     * {@link Bundle}.
    ...
    /**
     * This method can be overridden to restore state of this {@link ViewDialogFragment} from the given
     * {@link Bundle}.
    ...
    /**
     * This method can be overridden to save dependencies after the {@link ViewDialogFragment} is
    ...
    /**
     * This method can be overridden to restore dependencies after the {@link ViewDialogFragment} is
     * restored, for instance, after recreating it.
     *
